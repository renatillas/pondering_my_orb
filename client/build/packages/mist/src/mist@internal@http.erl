...
?DOC(false).
-spec add_date_header(gleam@http@response:response(KKZ)) -> gleam@http@response:response(KKZ).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(KLC)) -> gleam@http@response:response(KLC).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(KLF)) -> gleam@http@response:response(KLF).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(KLI)) -> gleam@http@response:response(KLI).
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(KLN)) -> gleam@http@response:response(KLN)).
