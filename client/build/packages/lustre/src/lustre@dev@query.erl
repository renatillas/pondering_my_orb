...
-spec find_matching_in_list(
    list(lustre@vdom@vnode:element(WMB)),
    selector(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(WMB), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_direct_child(
    lustre@vdom@vnode:element(WLW),
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(WLW), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_all_matching_in_list(
    list(lustre@vdom@vnode:element(WNJ)),
    selector()
) -> list(lustre@vdom@vnode:element(WNJ)).
...
-spec find_all_direct_children(lustre@vdom@vnode:element(WNF), selector()) -> list(lustre@vdom@vnode:element(WNF)).
...
-spec find_all_in_list(list(lustre@vdom@vnode:element(WNA)), 'query'()) -> list(lustre@vdom@vnode:element(WNA)).
...
-spec find_all(lustre@vdom@vnode:element(WMS), 'query'()) -> list(lustre@vdom@vnode:element(WMS)).
find_all(Root, Query) ->
    case Query of
        {find_element, Selector} ->
...
-spec find_all_in_children(lustre@vdom@vnode:element(WMW), 'query'()) -> list(lustre@vdom@vnode:element(WMW)).
...
-spec find_all_descendants_in_list(
    list(lustre@vdom@vnode:element(WNS)),
    selector()
) -> list(lustre@vdom@vnode:element(WNS)).
...
-spec find_all_descendants(lustre@vdom@vnode:element(WNO), selector()) -> list(lustre@vdom@vnode:element(WNO)).
...
-spec find_in_list(
    list(lustre@vdom@vnode:element(WLQ)),
    'query'(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(WLQ), lustre@vdom@path:path()}} |
    {error, nil}.
...
?DOC(false).
-spec find_path(
    lustre@vdom@vnode:element(WLG),
    'query'(),
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(WLG), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_in_children(
    lustre@vdom@vnode:element(WLL),
    'query'(),
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(WLL), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find(lustre@vdom@vnode:element(WLB), 'query'()) -> {ok,
        lustre@vdom@vnode:element(WLB)} |
    {error, nil}.
find(Root, Query) ->
...
-spec find_descendant_in_list(
    list(lustre@vdom@vnode:element(WMM)),
    selector(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(WMM), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_descendant(
    ...
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(WMH), lustre@vdom@path:path()}} |
    {error, nil}.
