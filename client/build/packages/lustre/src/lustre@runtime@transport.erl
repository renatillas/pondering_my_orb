...
-type client_message(TBS) :: {mount,
        ...
        lustre@vdom@vnode:element(TBS),
        lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(TBS)), lustre@vdom@vnode:element(TBS))} |
    {reconcile,
        integer(),
        lustre@vdom@patch:patch(TBS),
        lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(TBS)), lustre@vdom@vnode:element(TBS))} |
...
-spec mount_to_json(
    ...
    list(binary()),
    gleam@dict:dict(binary(), gleam@json:json()),
    lustre@vdom@vnode:element(TCS),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(TCS)), lustre@vdom@vnode:element(TCS))
) -> gleam@json:json().
mount_to_json(
    Kind,
    Open_shadow_root,
...
-spec reconcile_to_json(
    integer(),
    lustre@vdom@patch:patch(TCV),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(TCV)), lustre@vdom@vnode:element(TCV))
) -> gleam@json:json().
...
-spec mount(
    ...
    list(binary()),
    gleam@dict:dict(binary(), gleam@json:json()),
    lustre@vdom@vnode:element(TBY),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(TBY)), lustre@vdom@vnode:element(TBY))
) -> client_message(TBY).
mount(
    Open_shadow_root,
    Will_adopt_styles,
...
?DOC(false).
-spec reconcile(
    lustre@vdom@patch:patch(TCC),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(TCC)), lustre@vdom@vnode:element(TCC))
) -> client_message(TCC).
