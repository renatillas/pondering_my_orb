////
//// Health bar component for the game UI.
////
//// Displays player health as a horizontal bar with current/max values.
//// Styled with Tailwind CSS and red gradient colors.
////
...
/// Render a health bar showing current and maximum health
///
/// ## Example
///
/// ```gleam
/// health_bar.view(75.0, 100.0)
/// ```
    ...
    html.div(
      ...
      [
        ...
        html.div(
          [
            class(
              "h-full bg-gradient-to-r from-red-600 to-red-500 transition-all duration-300 ease-out",
            ),
