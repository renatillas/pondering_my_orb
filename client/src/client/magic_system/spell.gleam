...
pub type Spell {
  DamageSpell(id: Id, ui_sprite: String, kind: DamageSpell)
  ModifierSpell(id: Id, ui_sprite: String, kind: ModifierSpell)
  MulticastSpell(id: Id, ui_sprite: String, kind: MulticastSpell)
}
...
pub fn apply_modifiers(
  ...
  let #(
    ...
    apply_multiplicative_modifiers(after_additions, spell.mana_cost, modifiers)

  ModifiedSpell(
    base: DamageSpell(id:, ui_sprite:, kind: spell),
    final_damage:,
    final_speed:,
    final_size:,
    final_lifetime:,
...
pub fn lightning() -> Spell {
  DamageSpell(
    ...
    kind: Damage(
      ...
      projectile_lifetime: duration.milliseconds(1000),
      mana_cost: 100.0,
      projectile_size: 1.0,
      ...
      visuals: SpellVisuals(
        projectile: StaticSprite(
          texture_path: "spell_projectiles/lightning_bolt.png",
          size: vec2.Vec2(0.5, 0.5),
        ),
        hit_effect: NoEffect,
        base_tint: 0xFFFFFF,
        emissive_intensity: 1.0,
...
pub fn fireball() -> Spell {
  DamageSpell(
    ...
    kind: Damage(
      ...
      visuals: SpellVisuals(
        projectile: StaticSprite(
          texture_path: "spell_projectiles/fireball.png",
...
pub fn orbiting_spell() -> Spell {
  DamageSpell(
    ...
    kind: Damage(
      ...
      visuals: SpellVisuals(
        projectile: StaticSprite(
          texture_path: "spell_projectiles/orbiting_shards.png",
          size: vec2.Vec2(1.5, 1.5),
        ),
        hit_effect: NoEffect,
        base_tint: 0xFFFFFF,
        emissive_intensity: 1.0,
...
pub fn rapid_fire() -> Spell {
  ModifierSpell(
    id: RapidFire,
    ui_sprite: "spell_icons/rapid_fire.png",
    kind: Modifier(
...
pub fn add_damage() -> Spell {
  ModifierSpell(
    id: AddDamage,
    ui_sprite: "spell_icons/add_damage.png",
    kind: Modifier(
...
pub fn piercing() -> Spell {
  ModifierSpell(
    id: Piercing,
    ui_sprite: "spell_icons/piercing.png",
    kind: Modifier(
...
pub fn spark_with_trigger() -> Spell {
  DamageSpell(
    id: SparkWithTrigger,
    ui_sprite: "spell_icons/spark_with_trigger.png",
    kind: Damage(
...
pub fn add_trigger() -> Spell {
  ModifierSpell(
    id: AddTrigger,
    ui_sprite: "spell_icons/add_trigger.png",
    kind: Modifier(
...
pub fn name(spell: Spell) -> String {
  case spell {
    DamageSpell(kind:, ..) -> kind.name
    ModifierSpell(kind:, ..) -> kind.name
    MulticastSpell(kind:, ..) -> kind.name
  }
}
