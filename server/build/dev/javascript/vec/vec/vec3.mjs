...
export const Vec3$Vec3 = (x, y, z) => new Vec3(x, y, z);
export const Vec3$isVec3 = (value) => value instanceof Vec3;
export const Vec3$Vec3$x = (value) => value.x;
export const Vec3$Vec3$0 = (value) => value.x;
export const Vec3$Vec3$y = (value) => value.y;
export const Vec3$Vec3$1 = (value) => value.y;
export const Vec3$Vec3$z = (value) => value.z;
export const Vec3$Vec3$2 = (value) => value.z;
