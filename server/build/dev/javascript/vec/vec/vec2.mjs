...
export const Vec2$Vec2 = (x, y) => new Vec2(x, y);
export const Vec2$isVec2 = (value) => value instanceof Vec2;
export const Vec2$Vec2$x = (value) => value.x;
export const Vec2$Vec2$0 = (value) => value.x;
export const Vec2$Vec2$y = (value) => value.y;
export const Vec2$Vec2$1 = (value) => value.y;
