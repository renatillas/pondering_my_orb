...
export const Vec4$Vec4 = (x, y, z, w) => new Vec4(x, y, z, w);
export const Vec4$isVec4 = (value) => value instanceof Vec4;
export const Vec4$Vec4$x = (value) => value.x;
export const Vec4$Vec4$0 = (value) => value.x;
export const Vec4$Vec4$y = (value) => value.y;
export const Vec4$Vec4$1 = (value) => value.y;
export const Vec4$Vec4$z = (value) => value.z;
export const Vec4$Vec4$2 = (value) => value.z;
export const Vec4$Vec4$w = (value) => value.w;
export const Vec4$Vec4$3 = (value) => value.w;
