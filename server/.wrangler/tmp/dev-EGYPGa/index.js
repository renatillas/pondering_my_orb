...
// .wrangler/tmp/bundle-p9DyDw/checked-fetch.js
...
var GameRoom = class {
  ...
  async handleJoin(ws, playerId, roomId, playerName) {
    ...
    if (existingPlayers.length === 0) {
      console.log("[GameRoom] Starting game loop");
...
// .wrangler/tmp/bundle-p9DyDw/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-p9DyDw/middleware-loader.entry.ts
